...
$message = "<!DOCTYPE html> <html><head> $tableCSS </head><body>";
...
$message .= " <p class=\"h_message\">Good Morning Ops Team,<br>The following is a breakdown of all $oosum Outstanding orders from $todaysDate and $oldDate :</p><br />";
$message .= "<br />
            <li>Security Team: You have <b>$securityCounter</b> orders that needs to be settled.</li>
            <li>CS Department: You have <b>$csCounter</b> orders that are on Hold or Corporate.</li>  
            <li>ITC: We have <b>$itcCounter</b> orders that are on oversold or need settling. </li>
            <li>Exporting/FF: We have <b>$ffCounter</b> missing fulfillment flow </li>";
